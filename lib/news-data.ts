...
export const newsArticles: NewsArticle[] = [
  ...
  },
  {
    ...
    contentEn: [
      ...
      'The foundation will work alongside existing initiatives including Pars Network, which provides privacy-preserving communications infrastructure, and MIGA Protocol, which supports transparent humanitarian funding.',
    ...
    contentFa: [
      ...
      'این بنیاد در کنار ابتکارات موجود از جمله شبکه پارس، که زیرساخت ارتباطات حفظ حریم خصوصی را فراهم می‌کند، و پروتکل میگا، که از تأمین مالی بشردوستانه شفاف حمایت می‌کند، فعالیت خواهد کرد.',
  ...
  },
  {
    ...
    excerptEn: 'New public goods fund focuses on technology, education, and humanitarian initiatives.',
    excerptFa: 'صندوق کالاهای عمومی جدید بر فناوری، آموزش و ابتکارات بشردوستانه متمرکز است.',
    contentEn: [
